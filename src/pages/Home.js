...
const Home = () => {
  ...
  const Head = () => {
    return (
      <div className='flex items-center p-5 md:px-24 md:py-7 font-[mulish] bg-white'>
  ...
  return (
    <div>
      ...
      {/* Jumbotron */}
      <div className='flex flex-col md:flex-row md:items-center p-5 md:px-24 md:py-7 font-[mulish] bg-white'>
      ...
      {/* Upcoming */}
      <div className='py-10 font-[mulish] bg-white'>
      ...
      {/* Join */}
      <div className='font-[mulish] py-10 px-5 md:px-[100px] bg-white'>
        <div className='shadow-md py-10 text-center'>
          ...
          <div className='my-7 gap-4'>
            <input className='w-[300px] h-[50px] pl-4 border-[2px] rounded-[4px] focus:outline-none mr-5 bg-white' placeholder='Type your email'></input>
