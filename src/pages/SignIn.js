...
const SignIn = () => {
  return(
    <div className='flex font-[inter]'>
      {/* Left */}
      <div className="flex-[60%] bg-[url('../images/image1.png')]">
      ...
      <div className="flex flex-col flex-[40%] justify-center p-10">
        ...
        <div className='text-[#8692A6] text-center mb-2'>Forgot your password? <span className='text-[#5F2EEA] underline cursor-pointer'>Reset now</span></div>
